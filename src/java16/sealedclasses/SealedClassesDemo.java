 ...
 * Demonstrates sealed classes and interfaces with refinements
 * 
 * NOTE: Requires --enable-preview flag for compilation and execution
 * Compile: javac --enable-preview --release 16 SealedClassesDemo.java
 * Run: java --enable-preview SealedClassesDemo
 */
public class SealedClassesDemo {
    public static void main(String[] args) {
        ...
        // 2. Pattern matching with sealed classes (Java 16)
    ...
    private static void processShape(Shape shape) {
        // Pattern matching with sealed classes (Java 16)
        // Using instanceof pattern matching (switch pattern matching comes in Java 17)
        String result;
    ...
    private static void processAnimal(Animal animal) {
        ...
        if (animal instanceof Dog dog) {
            System.out.println("Dog: " + dog.name() + " barks");
        } else if (animal instanceof Cat cat) {
            System.out.println("Cat: " + cat.name() + " meows");
        } else if (animal instanceof Bird bird) {
            System.out.println("Bird: " + bird.name() + " chirps");
        }
    }
