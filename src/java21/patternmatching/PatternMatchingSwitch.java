package java21.patternmatching;

/**
 * Java 21 Pattern Matching for switch (Finalized) Demonstrates pattern matching with switch expressions
 */
public class PatternMatchingSwitch
{
	public static void main(String[] args)
	{
		System.out.println("=== Java 21 Pattern Matching for switch (Finalized) ===\n");
