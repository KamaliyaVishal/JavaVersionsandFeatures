package java19.patternmatching;

/**
 * Java 19 Pattern Matching for switch (Fourth Preview) Demonstrates pattern matching with switch expressions
 * NOTE: Requires --enable-preview flag for compilation and execution Compile: javac --enable-preview --release 19 PatternMatchingSwitch.java Run: java --enable-preview PatternMatchingSwitch
 */
public class PatternMatchingSwitch
{
	public static void main(String[] args)
	{
		...
		System.out.println("=== Java 19 Pattern Matching for switch (Fourth Preview) ===\n");
