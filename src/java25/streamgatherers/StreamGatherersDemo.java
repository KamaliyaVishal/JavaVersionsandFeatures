package java25.streamgatherers;
...
/**
 * Java 25 Stream Gatherers (Fifth Preview) Demonstrates custom intermediate stream operations
 * NOTE: Requires --enable-preview flag for compilation and execution
 * Compile: javac --enable-preview --release 25 StreamGatherersDemo.java
 * Run: java --enable-preview StreamGatherersDemo
 */
public class StreamGatherersDemo
{
	public static void main(String[] args)
	{
		System.out.println("=== Java 25 Stream Gatherers (Fifth Preview) ===\n");
		...
		System.out.println("\nNote: This is a preview feature in Java 25 (Fifth Preview).");
