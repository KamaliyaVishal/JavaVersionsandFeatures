package java23.unnamedclasses;

/**
 * Java 23 Implicitly Declared Classes and Instance Main Methods (Third Preview)
 * Demonstrates simplified class structure for simple programs
 * 
 * NOTE: Requires --enable-preview flag for compilation and execution
 * Compile: javac --enable-preview --release 23 UnnamedClassesAndInstanceMain.java
 * Run: java --enable-preview UnnamedClassesAndInstanceMain
 */
public class UnnamedClassesAndInstanceMain {
    public static void main(String[] args) {
        System.out.println("=== Java 23 Implicitly Declared Classes and Instance Main Methods (Third Preview) ===\n");
        ...
        System.out.println("""
            ...
            // Compile: javac --enable-preview --release 23 Hello.java
