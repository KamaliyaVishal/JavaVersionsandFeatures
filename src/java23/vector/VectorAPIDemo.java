package java23.vector;

/**
 * Java 23 Vector API (Eighth Incubator)
...
public class VectorAPIDemo {
    public static void main(String[] args) {
        System.out.println("=== Java 23 Vector API (Eighth Incubator) ===\n");
        ...
        System.out.println("\nNote: This is an incubator feature in Java 23.");
