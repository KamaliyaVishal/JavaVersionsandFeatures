package java15.textblocks;

/**
 * Java 15 Text Blocks (Finalized)
 * 
 * Text blocks are now a standard feature - no --enable-preview flag needed!
 */
public class TextBlocks {
    public static void main(String[] args) {
        
        System.out.println("=== Text Blocks (Finalized) ===\n");
        ...
        // 6. Using formatted() with text blocks
        System.out.println("\n--- Using formatted() ---");
        String name = "Java";
        int version = 15;
        String message = """
            Welcome to %s %d!
            Text blocks are now a standard feature.
        ...
        System.out.println("5. Standard feature (no preview flag needed)");
    }
}
