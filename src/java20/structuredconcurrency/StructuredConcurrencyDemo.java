package java20.structuredconcurrency;

/**
 * Java 20 Structured Concurrency (Second Incubator)
 * Demonstrates structured task scopes for concurrent programming
 * 
 * NOTE: Requires:
 * - --add-modules jdk.incubator.concurrent
 * - --enable-preview
 * 
 * Compile: javac --add-modules jdk.incubator.concurrent --enable-preview --release 20 StructuredConcurrencyDemo.java
 * Run: java --add-modules jdk.incubator.concurrent --enable-preview StructuredConcurrencyDemo
 */
public class StructuredConcurrencyDemo {
    public static void main(String[] args) {
        System.out.println("=== Java 20 Structured Concurrency (Second Incubator) ===\n");
